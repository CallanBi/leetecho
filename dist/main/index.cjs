...
const util_1$O = require$$1__default$1["default"];
...
function falseSchemaError$1(it, overrideAllErrors) {
  ...
  (0, errors_1$5.reportError)(cxt, boolError$1, void 0, overrideAllErrors);
}
var dataType$1 = {};
var rules$1 = {};
...
function checkMissingProp$1({ gen, data, it: { opts: opts2 } }, properties2, missing) {
  return (0, codegen_1$U.or)(...properties2.map((prop) => (0, codegen_1$U.and)(noPropertyInData$1(gen, data, prop, opts2.ownProperties), (0, codegen_1$U._)`${missing} = ${prop}`)));
}
...
function usePattern$1({ gen, it: { opts: opts2 } }, pattern2) {
  const u = opts2.unicodeRegExp ? "u" : "";
  const { regExp } = opts2.code;
  return gen.scopeValue("pattern", {
    key: pattern2,
    ref: regExp(pattern2, u),
...
function validateKeywordUsage$1({ schema, opts: opts2, self: self2, errSchemaPath }, def2, keyword2) {
...
function extendSubschemaData$1(subschema2, it, { dataProp, dataPropType: dpType, data, dataTypes, propertyName }) {
  ...
  if (dataProp !== void 0) {
    ...
    subschema2.errorPath = (0, codegen_1$S.str)`${errorPath}${(0, util_1$L.getErrorPath)(dataProp, dpType, opts2.jsPropertySyntax)}`;
...
var traverse$3 = jsonSchemaTraverse$1.exports = function(schema, opts2, cb) {
  ...
  _traverse$1(opts2, pre, post, schema, "", schema);
};
traverse$3.keywords = {
...
function _traverse$1(opts2, pre, post, schema, jsonPtr, rootSchema, parentJsonPtr, parentKeyword, parentSchema, keyIndex) {
      ...
      if (Array.isArray(sch)) {
        if (key in traverse$3.arrayKeywords) {
          for (var i = 0; i < sch.length; i++)
            _traverse$1(opts2, pre, post, sch[i], jsonPtr + "/" + key + "/" + i, rootSchema, jsonPtr, key, schema, i);
        }
      } else if (key in traverse$3.propsKeywords) {
        if (sch && typeof sch == "object") {
          for (var prop in sch)
            _traverse$1(opts2, pre, post, sch[prop], jsonPtr + "/" + key + "/" + escapeJsonPtr$1(prop), rootSchema, jsonPtr, key, schema, prop);
        }
      } else if (key in traverse$3.keywords || opts2.allKeys && !(key in traverse$3.skipKeywords)) {
        _traverse$1(opts2, pre, post, sch, jsonPtr + "/" + key, rootSchema, jsonPtr, key, schema);
      }
    }
...
const traverse$2 = jsonSchemaTraverse$1.exports;
const URI$3 = uri_all.exports;
...
function resolveUrl$1(baseId, id2) {
  id2 = normalizeId$1(id2);
  return URI$3.resolve(baseId, id2);
}
...
function getSchemaRefs$1(schema, baseId) {
  ...
  const baseIds = { "": schId };
  const pathPrefix = getFullPath$1(schId, false);
  const localRefs = {};
  ...
  traverse$2(schema, { allKeys: true }, (sch, jsonPtr, _, parentJsonPtr) => {
    ...
    function addRef(ref2) {
      ref2 = normalizeId$1(baseId2 ? URI$3.resolve(baseId2, ref2) : ref2);
  ...
  function checkAmbiguosRef(sch1, sch2, ref2) {
    if (sch2 !== void 0 && !equal$5(sch1, sch2))
      throw ambiguos(ref2);
  }
...
function validateFunction$1({ gen, validateName, schema, schemaEnv, opts: opts2 }, body) {
  if (opts2.code.es5) {
    gen.func(validateName, (0, codegen_1$R._)`${names_1$a.default.data}, ${names_1$a.default.valCxt}`, schemaEnv.$async, () => {
      gen.code((0, codegen_1$R._)`"use strict"; ${funcSourceUrl$1(schema, opts2)}`);
      destructureValCxtES5$1(gen, opts2);
      gen.code(body);
    });
  } else {
    gen.func(validateName, (0, codegen_1$R._)`${names_1$a.default.data}, ${destructureValCxt$1(opts2)}`, schemaEnv.$async, () => gen.code(funcSourceUrl$1(schema, opts2)).code(body));
  }
}
function destructureValCxt$1(opts2) {
  return (0, codegen_1$R._)`{${names_1$a.default.instancePath}="", ${names_1$a.default.parentData}, ${names_1$a.default.parentDataProperty}, ${names_1$a.default.rootData}=${names_1$a.default.data}${opts2.dynamicRef ? (0, codegen_1$R._)`, ${names_1$a.default.dynamicAnchors}={}` : codegen_1$R.nil}}={}`;
}
function destructureValCxtES5$1(gen, opts2) {
...
function funcSourceUrl$1(schema, opts2) {
  const schId = typeof schema == "object" && schema[opts2.schemaId];
  return schId && (opts2.code.source || opts2.code.process) ? (0, codegen_1$R._)`/*# sourceURL=${schId} */` : codegen_1$R.nil;
}
...
function checkRefsAndKeywords$1(it) {
  ...
  if (schema.$ref && opts2.ignoreKeywordsWithRef && (0, util_1$J.schemaHasRulesButRef)(schema, self2.RULES)) {
...
function updateContext$1(it) {
  ...
  if (schId)
    it.baseId = (0, resolve_1$5.resolveUrl)(it.baseId, schId);
}
function checkAsyncSchema$1(it) {
  if (it.schema.$async && !it.schemaEnv.$async)
    throw new Error("async schema in sync schema");
}
function commentKeyword$1({ gen, schemaEnv, schema, errSchemaPath, opts: opts2 }) {
...
function schemaKeywords$1(it, types2, typeErrors, errsCount) {
  ...
  const { RULES } = self2;
  if (schema.$ref && (opts2.ignoreKeywordsWithRef || !(0, util_1$J.schemaHasRulesButRef)(schema, RULES))) {
  ...
  function groupKeywords(group) {
    if (!(0, applicability_1$1.shouldUseGroup)(schema, group))
      return;
    if (group.type) {
      gen.if((0, dataType_2$1.checkDataType)(group.type, data, opts2.strictNumbers));
...
function checkContextTypes$1(it, types2) {
  ...
  it.dataTypes = it.dataTypes.filter((t2) => includesType$1(types2, t2));
}
...
function getData$1($data, { dataLevel, dataNames, dataPathArr }) {
  ...
  for (const segment of segments) {
    if (segment) {
      data = (0, codegen_1$R._)`${data}${(0, codegen_1$R.getProperty)((0, util_1$J.unescapeJsonPointer)(segment))}`;
...
class MissingRefError$1 extends Error {
  constructor(baseId, ref2, msg) {
    ...
    this.missingRef = (0, resolve_1$4.resolveUrl)(baseId, ref2);
    this.missingSchema = (0, resolve_1$4.normalizeId)((0, resolve_1$4.getFullPath)(this.missingRef));
  }
}
...
function compileSchema$1(sch) {
  ...
  if (_sch)
    return _sch;
  const rootId = (0, resolve_1$3.getFullPath)(sch.root.baseId);
...
function resolveRef$1(root, baseId, ref2) {
  var _a;
  ref2 = (0, resolve_1$3.resolveUrl)(baseId, ref2);
...
function resolveSchema$1(root, ref2) {
  const p = URI$2.parse(ref2);
  const refPath = (0, resolve_1$3._getFullPath)(p);
  let baseId = (0, resolve_1$3.getFullPath)(root.baseId);
  ...
  if (id2 === (0, resolve_1$3.normalizeId)(ref2)) {
    ...
    if (schId)
      baseId = (0, resolve_1$3.resolveUrl)(baseId, schId);
...
function getJsonPointer$1(parsedRef, { baseId, schema, root }) {
  ...
  if (typeof schema != "boolean" && schema.$ref && !(0, util_1$I.schemaHasRulesButRef)(schema, this.RULES)) {
    const $ref = (0, resolve_1$3.resolveUrl)(baseId, schema.$ref);
...
const def$U = {
  ...
  code(cxt) {
    ...
    if (schOrEnv === void 0)
      throw new ref_error_1$1.default(baseId, $ref);
    ...
    function inlineRefSchema(sch) {
      const schName = gen.scopeValue("schema", opts2.code.source === true ? { ref: sch, code: (0, codegen_1$P.stringify)(sch) } : { ref: sch });
      const valid2 = gen.name("valid");
      const schCxt = cxt.subschema({
        schema: sch,
        dataTypes: [],
...
function callRef$1(cxt, v, sch, $async) {
  ...
  const passCxt = opts2.passContext ? names_1$8.default.this : codegen_1$P.nil;
  if ($async)
    callAsyncRef();
  else
    callSyncRef();
  ...
  function addEvaluatedFrom(source2) {
    ...
    if (it.props !== true) {
      if (schEvaluated && !schEvaluated.dynamicProps) {
        ...
        it.props = util_1$H.mergeEvaluated.props(gen, props, it.props, codegen_1$P.Name);
      }
    }
    if (it.items !== true) {
      if (schEvaluated && !schEvaluated.dynamicItems) {
        ...
        it.items = util_1$H.mergeEvaluated.items(gen, items2, it.items, codegen_1$P.Name);
      }
    }
  }
}
...
const def$R = {
  ...
  code(cxt) {
    ...
    const len = it.opts.unicode === false ? (0, codegen_1$M._)`${data}.length` : (0, codegen_1$M._)`${(0, util_1$G.useFunc)(cxt.gen, ucs2length_1$1.default)}(${data})`;
  ...
  code(cxt) {
    ...
    function loopAllRequired() {
      gen.forOf("prop", schemaCode, (prop) => {
        ...
        gen.if((0, code_1$g.noPropertyInData)(gen, data, prop, opts2.ownProperties), () => cxt.error());
      });
    }
    function loopUntilMissing(missing, valid2) {
      cxt.setParams({ missingProperty: missing });
      gen.forOf(missing, schemaCode, () => {
        gen.assign(valid2, (0, code_1$g.propertyInData)(gen, data, missing, opts2.ownProperties));
...
const def$L = {
  ...
  code(cxt) {
    ...
    if ($data || schema && typeof schema == "object") {
      cxt.fail$data((0, codegen_1$G._)`!${(0, util_1$D.useFunc)(gen, equal_1$4.default)}(${data}, ${schemaCode})`);
    } else {
...
const def$K = {
  ...
  code(cxt) {
    ...
    const eql = (0, util_1$C.useFunc)(gen, equal_1$3.default);
    let valid2;
    if (useLoop || $data) {
    ...
    function loopEnum() {
      gen.assign(valid2, false);
      gen.forOf("v", schemaCode, (v) => gen.if((0, codegen_1$F._)`${eql}(${data}, ${v})`, () => gen.assign(valid2, true).break()));
    }
    function equalCode(vSchema, i) {
      const sch = schema[i];
      return typeof sch === "object" && sch !== null ? (0, codegen_1$F._)`${eql}(${data}, ${vSchema}[${i}])` : (0, codegen_1$F._)`${data} === ${sch}`;
    }
  }
};
...
function validateTuple$1(cxt, extraItems, schArr = cxt.schema) {
  ...
  function checkStrictTuple(sch) {
    ...
    if (opts2.strictTuples && !fullTuple) {
      ...
      (0, util_1$A.checkStrictMode)(it, msg, opts2.strictTuples);
    }
  }
}
...
const def$F = {
  ...
  code(cxt) {
    ...
    if (max === void 0 && min === 1) {
      ...
      if (min === 0) {
        gen.if((0, codegen_1$B._)`${data}.length > 0`, validateItemsWithCount, () => gen.assign(valid2, true));
      } else {
...
const def$D = {
  ...
  code(cxt) {
    ...
    it.props = true;
    if (opts2.removeAdditional !== "all" && (0, util_1$w.alwaysValidSchema)(it, schema))
      return;
...
const def$u = {
  ...
  code(cxt, ruleType) {
    ...
    function validate$DataFormat() {
      ...
      gen.if((0, codegen_1$v._)`typeof ${fDef} == "object" && !(${fDef} instanceof RegExp)`, () => gen.assign(fType, (0, codegen_1$v._)`${fDef}.type || "string"`).assign(format2, (0, codegen_1$v._)`${fDef}.validate`), () => gen.assign(fType, (0, codegen_1$v._)`"string"`).assign(format2, fDef));
      cxt.fail$data((0, codegen_1$v.or)(unknownFmt(), invalidFmt()));
      function unknownFmt() {
        if (opts2.strictSchema === false)
          return codegen_1$v.nil;
        return (0, codegen_1$v._)`${schemaCode} && !${format2}`;
      }
      function invalidFmt() {
        const callFormat = schemaEnv.$async ? (0, codegen_1$v._)`(${fDef}.async ? await ${format2}(${data}) : ${format2}(${data}))` : (0, codegen_1$v._)`${format2}(${data})`;
        const validData = (0, codegen_1$v._)`(typeof ${format2} == "function" ? ${callFormat} : ${format2}.test(${data}))`;
        return (0, codegen_1$v._)`${format2} && ${format2} !== true && ${fType} === ${ruleType} && !${validData}`;
      }
    }
    function validateFormat() {
      ...
      function getFormat(fmtDef) {
        const code2 = fmtDef instanceof RegExp ? (0, codegen_1$v.regexpCode)(fmtDef) : opts2.code.formats ? (0, codegen_1$v._)`${opts2.code.formats}${(0, codegen_1$v.getProperty)(schema)}` : void 0;
      ...
      function validCondition() {
        ...
        return typeof format2 == "function" ? (0, codegen_1$v._)`${fmtRef}(${data})` : (0, codegen_1$v._)`${fmtRef}.test(${data})`;
      }
    }
  }
};
...
function extendSubschemaData(subschema2, it, { dataProp, dataPropType: dpType, data, dataTypes, propertyName }) {
  ...
  if (dataProp !== void 0) {
    ...
    dataContextProps(nextData);
    subschema2.errorPath = (0, codegen_1$o.str)`${errorPath}${(0, util_1$m.getErrorPath)(dataProp, dpType, opts2.jsPropertySyntax)}`;
...
function checkRefsAndKeywords(it) {
  const { schema, errSchemaPath, opts: opts2, self: self2 } = it;
  if (schema.$ref && opts2.ignoreKeywordsWithRef && (0, util_1$k.schemaHasRulesButRef)(schema, self2.RULES)) {
    self2.logger.warn(`$ref: keywords ignored in schema at path "${errSchemaPath}"`);
  }
}
...
function schemaKeywords(it, types2, typeErrors, errsCount) {
  const { gen, schema, data, allErrors, opts: opts2, self: self2 } = it;
  const { RULES } = self2;
  if (schema.$ref && (opts2.ignoreKeywordsWithRef || !(0, util_1$k.schemaHasRulesButRef)(schema, RULES))) {
...
function validateTuple(cxt, extraItems, schArr = cxt.schema) {
  ...
  function checkStrictTuple(sch) {
    ...
    if (opts2.strictTuples && !fullTuple) {
      const msg = `"${keyword2}" is ${l}-tuple, but minItems or maxItems/${extraItems} are not specified or different at path "${errSchemaPath}"`;
      (0, util_1$b.checkStrictMode)(it, msg, opts2.strictTuples);
    }
  }
}
...
const def$c = {
  ...
  code(cxt) {
    ...
    if (max === void 0 && min === 1) {
      ...
      gen.let(valid2, false);
      if (min === 0) {
        gen.if((0, codegen_1$7._)`${data}.length > 0`, validateItemsWithCount, () => gen.assign(valid2, true));
      } else {
        validateItemsWithCount();
      }
    }
...
const def$a = {
  ...
  code(cxt) {
    ...
    const { allErrors, opts: opts2 } = it;
    it.props = true;
    if (opts2.removeAdditional !== "all" && (0, util_1$7.alwaysValidSchema)(it, schema))
      return;
...
const def$9 = {
  ...
  code(cxt) {
    ...
    const properties2 = allProps.filter((p) => !(0, util_1$6.alwaysValidSchema)(it, schema[p]));
    if (properties2.length === 0)
      return;
    const valid2 = gen.name("valid");
    for (const prop of properties2) {
...
function hasSchema(it, keyword2) {
  const schema = it.schema[keyword2];
  return schema !== void 0 && !(0, util_1$1.alwaysValidSchema)(it, schema);
}
_if.default = def$3;
var thenElse = {};
